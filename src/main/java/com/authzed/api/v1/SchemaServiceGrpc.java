...
public final class SchemaServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.authzed.api.v1.SchemaServiceOuterClass.ReadSchemaRequest,
      com.authzed.api.v1.SchemaServiceOuterClass.ReadSchemaResponse> getReadSchemaMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ReadSchema",
      requestType = com.authzed.api.v1.SchemaServiceOuterClass.ReadSchemaRequest.class,
      responseType = com.authzed.api.v1.SchemaServiceOuterClass.ReadSchemaResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.authzed.api.v1.SchemaServiceOuterClass.ReadSchemaRequest,
      com.authzed.api.v1.SchemaServiceOuterClass.ReadSchemaResponse> getReadSchemaMethod() {
      ...
      synchronized (SchemaServiceGrpc.class) {
        if ((getReadSchemaMethod = SchemaServiceGrpc.getReadSchemaMethod) == null) {
          SchemaServiceGrpc.getReadSchemaMethod = getReadSchemaMethod =
              io.grpc.MethodDescriptor.<com.authzed.api.v1.SchemaServiceOuterClass.ReadSchemaRequest, com.authzed.api.v1.SchemaServiceOuterClass.ReadSchemaResponse>newBuilder()
  ...
  private static volatile io.grpc.MethodDescriptor<com.authzed.api.v1.SchemaServiceOuterClass.WriteSchemaRequest,
      com.authzed.api.v1.SchemaServiceOuterClass.WriteSchemaResponse> getWriteSchemaMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "WriteSchema",
      requestType = com.authzed.api.v1.SchemaServiceOuterClass.WriteSchemaRequest.class,
      responseType = com.authzed.api.v1.SchemaServiceOuterClass.WriteSchemaResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.authzed.api.v1.SchemaServiceOuterClass.WriteSchemaRequest,
      com.authzed.api.v1.SchemaServiceOuterClass.WriteSchemaResponse> getWriteSchemaMethod() {
      ...
      synchronized (SchemaServiceGrpc.class) {
        if ((getWriteSchemaMethod = SchemaServiceGrpc.getWriteSchemaMethod) == null) {
          SchemaServiceGrpc.getWriteSchemaMethod = getWriteSchemaMethod =
              io.grpc.MethodDescriptor.<com.authzed.api.v1.SchemaServiceOuterClass.WriteSchemaRequest, com.authzed.api.v1.SchemaServiceOuterClass.WriteSchemaResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.authzed.api.v1.SchemaServiceOuterClass.ReadSchemaRequest,
                com.authzed.api.v1.SchemaServiceOuterClass.ReadSchemaResponse>(
                  this, METHODID_READ_SCHEMA)))
          .addMethod(
            getWriteSchemaMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.authzed.api.v1.SchemaServiceOuterClass.WriteSchemaRequest,
                com.authzed.api.v1.SchemaServiceOuterClass.WriteSchemaResponse>(
  ...
  public static final class SchemaServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<SchemaServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.authzed.api.v1.SchemaServiceOuterClass.ReadSchemaResponse readSchema(com.authzed.api.v1.SchemaServiceOuterClass.ReadSchemaRequest request) {
     ...
     * </pre>
     */
    public com.authzed.api.v1.SchemaServiceOuterClass.WriteSchemaResponse writeSchema(com.authzed.api.v1.SchemaServiceOuterClass.WriteSchemaRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
