...
public final class WatchServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.authzed.api.v1.WatchServiceOuterClass.WatchRequest,
      com.authzed.api.v1.WatchServiceOuterClass.WatchResponse> getWatchMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Watch",
      requestType = com.authzed.api.v1.WatchServiceOuterClass.WatchRequest.class,
      responseType = com.authzed.api.v1.WatchServiceOuterClass.WatchResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.authzed.api.v1.WatchServiceOuterClass.WatchRequest,
      com.authzed.api.v1.WatchServiceOuterClass.WatchResponse> getWatchMethod() {
      ...
      synchronized (WatchServiceGrpc.class) {
        if ((getWatchMethod = WatchServiceGrpc.getWatchMethod) == null) {
          WatchServiceGrpc.getWatchMethod = getWatchMethod =
              io.grpc.MethodDescriptor.<com.authzed.api.v1.WatchServiceOuterClass.WatchRequest, com.authzed.api.v1.WatchServiceOuterClass.WatchResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Watch"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.authzed.api.v1.WatchServiceOuterClass.WatchRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.authzed.api.v1.WatchServiceOuterClass.WatchResponse.getDefaultInstance()))
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                com.authzed.api.v1.WatchServiceOuterClass.WatchRequest,
                com.authzed.api.v1.WatchServiceOuterClass.WatchResponse>(
                  this, METHODID_WATCH)))
          .build();
    }
  }
