...
public final class Core {
    ...
    public static final class Builder extends
      ...
      public Builder mergeObject(com.authzed.api.v1.Core.ObjectReference value) {
        if (objectBuilder_ == null) {
          if (object_ != null) {
            object_ =
              com.authzed.api.v1.Core.ObjectReference.newBuilder(object_).mergeFrom(value).buildPartial();
          } else {
            object_ = value;
          }
          onChanged();
  ...
  private static final long serialVersionUID = 0L;
    ...
    @java.lang.Override public com.authzed.api.v1.Core.RelationshipUpdate.Operation getOperation() {
      ...
      com.authzed.api.v1.Core.RelationshipUpdate.Operation result = com.authzed.api.v1.Core.RelationshipUpdate.Operation.valueOf(operation_);
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              ...
              treeType_ =
                  input.readMessage(com.authzed.api.v1.Core.AlgebraicSubjectSet.parser(), extensionRegistry);
              if (subBuilder != null) {
            ...
            case 18: {
              ...
              treeType_ =
                  input.readMessage(com.authzed.api.v1.Core.DirectSubjectSet.parser(), extensionRegistry);
              if (subBuilder != null) {
            ...
            case 26: {
              ...
              expandedObject_ = input.readMessage(com.authzed.api.v1.Core.ObjectReference.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    public static final class Builder extends
      ...
      public Builder mergeExpandedObject(com.authzed.api.v1.Core.ObjectReference value) {
        if (expandedObjectBuilder_ == null) {
          if (expandedObject_ != null) {
            expandedObject_ =
              com.authzed.api.v1.Core.ObjectReference.newBuilder(expandedObject_).mergeFrom(value).buildPartial();
          } else {
            expandedObject_ = value;
          }
          onChanged();
  ...
  public interface AlgebraicSubjectSetOrBuilder extends
     ...
     */
    java.util.List<com.authzed.api.v1.Core.PermissionRelationshipTree> 
        getChildrenList();
    /**
     * <code>repeated .authzed.api.v1.PermissionRelationshipTree children = 2;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              ...
              children_.add(
                  input.readMessage(com.authzed.api.v1.Core.PermissionRelationshipTree.parser(), extensionRegistry));
              break;
            }
            default: {
              if (!parseUnknownField(
    ...
    @java.lang.Override public com.authzed.api.v1.Core.AlgebraicSubjectSet.Operation getOperation() {
      @SuppressWarnings("deprecation")
      com.authzed.api.v1.Core.AlgebraicSubjectSet.Operation result = com.authzed.api.v1.Core.AlgebraicSubjectSet.Operation.valueOf(operation_);
    ...
    public static final class Builder extends
       ...
       * <code>repeated .authzed.api.v1.PermissionRelationshipTree children = 2;</code>
       */
      public java.util.List<com.authzed.api.v1.Core.PermissionRelationshipTree.Builder> 
  ...
  public interface DirectSubjectSetOrBuilder extends
     ...
     */
    java.util.List<com.authzed.api.v1.Core.SubjectReference> 
        getSubjectsList();
    /**
     * <code>repeated .authzed.api.v1.SubjectReference subjects = 1;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
       ...
       * <code>repeated .authzed.api.v1.SubjectReference subjects = 1;</code>
       */
      public java.util.List<com.authzed.api.v1.Core.SubjectReference.Builder> 
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\013object_type\030\001 \001(\tBH\372BErC(\200\0012>^([a-z][a-" +
      "z0-9_]{1,61}[a-z0-9]/)?[a-z][a-z0-9_]{1," +
      "62}[a-z0-9]$\022G\n\tobject_id\030\002 \001(\tB4\372B1r/(\200" +
      ...
      "braicSubjectSet\022@\n\toperation\030\001 \001(\0162-.aut" +
      "hzed.api.v1.AlgebraicSubjectSet.Operatio" +
      "n\022<\n\010children\030\002 \003(\0132*.authzed.api.v1.Per" +
      "missionRelationshipTree\"p\n\tOperation\022\031\n\025" +
